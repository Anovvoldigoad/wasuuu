...
## Phase 2.2 runtime architecture update
Main process is now `win-x64` to avoid Wine ARM64EC experimental x86 WoW64 CoreCLR startup. The x86 CPK stack is externalized through YACpkTool.exe and CpkMaker.dll. See PHASE2_2_RUNTIME_FIX.md.
